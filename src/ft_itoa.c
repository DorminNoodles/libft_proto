...
/*   Updated: 2016/10/08 19:58:41 by lchety           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

int ft_digit_quantity(unsigned int n)
{
	int ret;
...
char *create_str(char * str, int neg, unsigned int nb)
{
	int digits;
...
char *recursive_itoa(char *str, unsigned int nb)
{
	if(nb > 10)
	{
